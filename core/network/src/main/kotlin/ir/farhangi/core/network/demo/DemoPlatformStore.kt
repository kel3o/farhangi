...
private fun seedArticles(): List<ArticleDto> = listOf(
    ...
    ArticleDto(
        ...
        "TEXT",
        "FAMILY",
        "آزمایش ساده‌ای که بیشتر خانواده‌ها از آن می‌ترسند و بعد پشیمان نمی‌شوند.",
        "گوشی‌ها را در کشو بگذارید. بازی رومیزی یا کتاب بلندخوانی. اولین بیست دقیقه سخت است؛ بعدش خانه صدا پیدا می‌کند. بسیاری از والدین می‌گویند «وقت نداریم»، اما همان شب می‌فهمند زمان آزاد بوده و توجه پراکنده بوده است. یک شب کافی است تا ببینید گفت‌وگو چقدر تشنه‌ی سکوت گوشی است. فردا لازم نیست کامل قطع کنید؛ همان یک ساعت را نگه دارید. اگر کودک مقاومت کرد، خودتان اول الگو شوید. نور صفحه را با نور لامپ عوض کنید و ببینید تن صداها چطور آرام‌تر می‌شود. گاهی یک شب آزمایش، شروع یک عادت هفتگی است. لازم نیست بی‌نقص باشد؛ لازم است شروع شود. خانه وقتی از اعلان‌ها خالی می‌شود، جا برای قصه‌ها باز می‌کند.",
        null,
        "cover_article_2",
    ...
    ArticleDto(
        "article-3",
        "هفته کتاب در کتابخانه‌های محلی",
        "NEWS",
        "NEWS",
        "برنامه امانت ویژه و نشست قصه‌خوانی برای نوجوانان در کتابخانه‌های محله.",
        "کتابخانه‌های محله این هفته امانت دوم را رایگان کرده‌اند. اگر عضو نیستید، همان روز ثبت‌نام کنید. نشست قصه‌خوانی عصرها برگزار می‌شود و مناسب خانواده‌هایی است که دنبال فعالیت کم‌هزینه هستند. خبر کوتاه است، اما اثرش در قفسه‌ی خانه دیده می‌شود: کتاب تازه، گفت‌وگوی تازه. مسئولان کتابخانه می‌گویند حضور نوجوانان نسبت به ماه قبل بیشتر شده است. اگر فرصت دارید، یکی از نشست‌ها را امتحان کنید و کتابی را با صدای بلند در خانه ورق بزنید. هفته کتاب فقط تقویم نیست؛ بهانه است برای برگشتن به قفسه. محله‌هایی که کتابخانه را زنده نگه می‌دارند، گفت‌وگوی عمومی قوی‌تری هم دارند. همین خبر کوچک می‌تواند مسیر هفته شما را عوض کند.",
        null,
        "cover_article_3",
    ...
    ArticleDto(
        "article-4",
        "کتاب ارزان‌تر از قهوه",
        "TEXT",
        "ECONOMY",
        "حساب‌وکتاب کوچک برای عادت مطالعه بدون فشار بودجه بزرگ.",
        "اگر هفته‌ای دو قهوه را به یک کتاب دست‌دوم تبدیل کنید، تا پایان سال یک قفسه دارید. اقتصاد فرهنگی از همین تصمیم‌های کوچک است. لازم نیست بودجه بزرگ داشته باشید؛ لازم است اولویت را جابه‌جا کنید. کتابی که ورق می‌خورد، برخلاف نوشیدنی، دوباره به کار می‌آید و گاهی دست نسل بعد می‌رسد. می‌توانید با دوستان حلقه امانت بسازید و هزینه را نصف کنید. گاهی ارزان‌ترین سرمایه‌گذاری، خریدن یک جلد و خواندن با صدای معمولی در خانه است. اگر از قیمت کتاب می‌ترسید، از کتابخانه شروع کنید؛ رایگان‌ترین راه برای شکست‌دادن بهانه پول است. عادت کوچک مالی، عادت بزرگ فرهنگی می‌سازد. قهوه تمام می‌شود؛ جمله می‌ماند.",
        null,
        "cover_article_4",
    ...
    ArticleDto(
        ...
        "TEXT",
        "POLITICS",
        "گفت‌وگوی عمومی بدون خرد کردن طرف مقابل؛ مهارتی که از خانه شروع می‌شود.",
        "سیاست فرهنگی یعنی بتوانیم مخالف باشیم و هنوز به یک صف نانوایی احترام بگذاریم. توهین، میان‌بر گرانی است. وقتی زبان تند می‌شود، گوش‌ها بسته می‌شوند و مسئله حل نمی‌شود. ادب مخالفت تمرین صبر است: حرف را بشنو، دلیل بیاور، و شخصیت طرف را له نکن. این مهارت از خانه و مدرسه شروع می‌شود، نه فقط از تریبون. می‌توان مخالف بود و همچنان برای طرف مقابل جا گذاشت. جامعه وقتی قوی است که اختلاف را تحمل کند بدون اینکه کرامت را خرج کند. اگر فقط برنده شدن مهم باشد، فهم مشترک می‌میرد. ادب مخالفت یعنی قدرت را در خویشتن‌داری ببینیم، نه در بلندترین فریاد. این تمرین روزانه است؛ در گروه خانوادگی، در محل کار و در فضای عمومی.",
        null,
        "cover_article_5",
    ...
    ArticleDto(
        ...
        "TEXT",
        "READING",
        "کوچک‌ترین سهمی که کتاب را در زندگی روزمره زنده نگه می‌دارد.",
        "موبایل را یک اتاق آن‌طرف‌تر شارژ کنید. ده صفحه، نه یک جلد. فردا همان خط را پیدا می‌کنید. عادت‌های بزرگ از بازه‌های کوتاه ساخته می‌شوند. اگر منتظر «وقت آزاد طولانی» بمانید، کتاب روی میز خاک می‌خورد. ده دقیقه منظم، از دو ساعت اتفاقی جلوتر است. نور ملایم و صندلی ثابت، شروع را آسان‌تر می‌کند. لازم نیست هر شب شاهکار بخوانید؛ لازم است حضور کتاب در برنامه شبانه قطع نشود. بعضی شب‌ها فقط یک بند کافی است تا ذهن از خبر و اعلان فاصله بگیرد. خواب بعد از مطالعه کوتاه، معمولاً آرام‌تر است. این ده دقیقه، سرمایه‌گذاری روی آرامش فرداست.",
        null,
        "cover_article_6",
    ...
    ArticleDto(
        "article-7",
        "خط روی دیوار آشپزخانه",
        "TEXT",
        "ART",
        "خوشنویسی لازم نیست قاب موزه باشد؛ می‌تواند بخشی از مسیر چای صبح باشد.",
        "یک سطر نستعلیق بالای ظرف‌ها، هر روز چشم را تمرین می‌دهد. هنر وقتی در مسیر چای است، فراموش نمی‌شود. لازم نیست کارگاه حرفه‌ای داشته باشید؛ یک مشق کوتاه و یک قاب ساده کافی است تا خانه رنگ فرهنگی بگیرد. هنر کاربردی، هنر زنده‌است. اگر خط کج شد، همان کجی بخشی از مسیر یادگیری است. کودکان وقتی هنر را روی دیوار خانه می‌بینند، آن را دور و تشریفاتی حس نمی‌کنند. می‌توانید هر ماه یک سطر تازه جایگزین کنید تا دیوار نفس بکشد. زیبایی کوچک تکرارشونده، قوی‌تر از اثر بزرگ فراموش‌شده است. خانه می‌تواند کارگاه آرام فرهنگ باشد.",
        null,
        "cover_article_7",
    ...
    ArticleDto(
        "article-8",
        "کتابخانه‌های نیشابور چه شدند؟",
        "TEXT",
        "HISTORY",
        "یادآوری اینکه دانش هم می‌تواند آتش بگیرد و باز هم باید بازسازی شود.",
        "سده‌ها پیش نیشابور ایستگاه کاغذ و درس بود. تاریخ را بخوانیم تا فقط به ویرانه فکر نکنیم؛ به همت بازسازی هم فکر کنیم. کتابخانه اگر نباشد، حافظه جمعی ضعیف می‌شود. امروز هم کتابخانه‌های محلی همان نقش را دارند، فقط با ساختمانی ساده‌تر و مردمی صبورتر. سوختن کتاب، سوختن امکان گفت‌وگوست. وقتی قفسه زنده است، نسل بعد منبع دارد نه فقط شایعه. حمایت از کتابخانه محله، دفاع از آینده فهم مشترک است. تاریخ را برای افسوس نخوانیم؛ برای مسئولیت بخوانیم. هر کتابخانه‌ای که امروز باز است، پاسخی است به تهدید فراموشی. حضور شما در آن فضا، ادامه همان همت قدیمی است.",
        null,
        "cover_article_8",
    ...
    ArticleDto(
        "article-9",
        "جلدهای کهنه مادربزرگ",
        "TEXT",
        "NARRATIVE",
        "بوی کاغذ و دارچین؛ روایتی خانوادگی که اگر نوشته نشود قطع می‌شود.",
        "مادربزرگ اسم شخصیت‌ها را عوض می‌کرد تا به نوه برسند. روایت خانوادگی اگر نوشته نشود، با یک نسل قطع می‌شود. جلد کهنه فقط شیء نیست؛ پرونده‌ای از صداها و شب‌های بلندخوانی است. اگر فرصت دارید، یکی از همان قصه‌ها را روی کاغذ یا در گوشی ثبت کنید؛ آینده از همین یادداشت‌ها ساخته می‌شود. گاهی یک جمله ناتمام مادربزرگ، کلید فهم خانواده است. کتاب کهنه را دور نریزید؛ حاشیه و تاشدگی‌اش بخشی از تاریخ خانه است. می‌توانید شب‌ها همان قصه را با صدای خودتان دوباره زنده کنید. میراث فرهنگی اول از خانه شروع می‌شود، بعد به موزه می‌رسد. جلد کهنه، دعوت است به شنیدن دوباره.",
        null,
        "cover_article_9",
