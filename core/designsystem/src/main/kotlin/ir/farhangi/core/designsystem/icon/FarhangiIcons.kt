...
object FarhangiIcons {
    ...
    val BooksOutlined: ImageVector = Icons.Outlined.MenuBook
    val Library: ImageVector = Icons.Filled.LocalLibrary
    val MyLibrary: ImageVector = Icons.Filled.Bookmark
    val Bookmark: ImageVector = Icons.Filled.Bookmark
    val BookmarkBorder: ImageVector = Icons.Outlined.BookmarkBorder
    val Courses: ImageVector = Icons.Filled.School
